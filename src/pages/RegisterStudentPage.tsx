...
import { Trophy, Mail, Lock, Key, Loader2, AlertCircle, ArrowLeft, CheckCircle, Users } from 'lucide-react';
import { useAuth, StudentRegisterData } from '../contexts/AuthContext';
          ...
          <div className="w-full max-w-md text-center">
            <div className="bg-[#16213e] rounded-2xl p-8 border border-green-500/30">
              ...
              <p className="text-white/70 mb-6">
                ...
                {formData.parent_email && ' A consent request has been sent to your parent\'s email.'}
              </p>
              <div className="bg-white/5 rounded-lg p-4 text-left mb-6">
                ...
                <ol className="list-decimal list-inside text-white/60 space-y-2 text-sm">
                  {formData.parent_email && <li>Ask your parent to check their email and approve your participation</li>}
                  <li>Log in to your account</li>
                  <li>Join a team or create your own</li>
                  <li>Start competing in STEM challenges!</li>
                </ol>
              </div>
              <Link
                to="/login"
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold mb-2">Join as Student</h1>
          ...
          <form onSubmit={handleSubmit} className="bg-[#16213e] rounded-2xl p-8 border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-white/40 mt-1">Get this code from your teacher</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-white/70 mb-2">Grade/Year</label>
                  <input
                    type="text"
                    name="grade"
              ...
              {/* Parent Email */}
              <div>
                <label className="block text-sm text-white/70 mb-2">Parent/Guardian Email</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-white/5 border border-white/20 rounded-lg pl-12 pr-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#4361ee] transition-colors"
                    placeholder="parent@email.com (for consent)"
                  />
                </div>
                <p className="text-xs text-white/40 mt-1">Required for students under 18</p>
              </div>
