...
export default function WhyFundWorldStemCupPage() {
  ...
  const DownloadButton = () => (
    <a 
      href="/docs/WSC_Why_Fund_World_STEM_Cup.pdf" 
      download
      style={{
        display: 'inline-flex',
        alignItems: 'center',
    ...
    >
      ...
      Download Why Fund World STEM Cup (PDF)
    </a>
  );
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <span style={{ color: '#f72585', fontWeight: '500' }}>Education Fund</span>
        </div>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            World STEM Cup Education Foundation offers a unique opportunity for donors, foundations, 
            and grant-makers to support global STEM education through competitive learning.
          </p>
          ...
          <p style={{
            ...
            Your investment supports students worldwide, providing access to quality STEM education, 
            competition resources, and opportunities for academic growth regardless of geographic 
          ...
          <p style={{
            ...
            For complete details on funding opportunities, impact metrics, and partnership options, 
        ...
        {/* Back to Education Fund */}
        <div style={{ textAlign: 'center', marginTop: '2rem' }}>
          <Link to="/education-fund" style={{
            color: 'rgba(255,255,255,0.7)',
            textDecoration: 'none',
            display: 'inline-flex',
            alignItems: 'center',
