...
export default function DataProtectionChildSafetyPage() {
  ...
  const DownloadButton = () => (
    <a 
      href="/docs/WSC_Data_Protection_Child_Safety_Statement.pdf" 
      download
      style={{
        display: 'inline-flex',
        alignItems: 'center',
    ...
    >
      ...
      Download Data Protection & Child Safety Statement (PDF)
    </a>
  );
    ...
    <div style={{
            ...
            >
              ...
              {showGovernanceDropdown && (
                <div style={{
                  ...
                  <Link to="/governance/data-protection-child-safety" style={{ display: 'block', padding: '0.5rem 1rem', fontSize: '0.875rem', color: 'white', textDecoration: 'none', fontWeight: '500' }}>Data Protection & Child Safety</Link>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <span style={{ color: '#f72585', fontWeight: '500' }}>Governance & Transparency</span>
        </div>
        ...
        <h1 style={{
          ...
          Data Protection &<br />
          <span style={{ color: '#ffd700' }}>Child Safety Statement</span>
        </h1>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            The protection of students is our highest priority. World STEM Cup Education Foundation 
            maintains comprehensive policies and procedures to safeguard student data and ensure 
            child safety across all programs and activities.
          </p>
          ...
          <p style={{
            ...
            Our data protection framework complies with applicable privacy regulations and educational 
            data protection standards, ensuring that student information is collected, stored, and 
          ...
          <p style={{
            ...
            For complete details on our data protection and child safety policies, please download 
            the full statement document.
          </p>
        </div>
