            ...
            >
              ...
              {showGovernanceDropdown && (
                <div style={{
                  ...
                  <Link to="/governance/academic-independence" style={{ display: 'block', padding: '0.5rem 1rem', fontSize: '0.875rem', color: 'white', textDecoration: 'none', fontWeight: '500' }}>Academic Independence</Link>
