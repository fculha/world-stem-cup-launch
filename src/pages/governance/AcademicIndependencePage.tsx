...
export default function AcademicIndependencePage() {
    ...
    <div style={{
            ...
            <div style={{ position: 'relative' }}>
              ...
              {showGovernanceDropdown && (
                <div style={{
                  ...
                  <Link to="/governance/academic-independence" onClick={() => setShowGovernanceDropdown(false)} style={{ display: 'block', padding: '0.5rem 1rem', fontSize: '0.875rem', color: 'white', textDecoration: 'none', fontWeight: '500' }}>Academic Independence</Link>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <span style={{ color: '#4361ee', fontWeight: '500' }}>Governance & Transparency</span>
        </div>
        ...
        <h1 style={{
          ...
          Academic Independence<br />
          <span style={{ color: '#ffd700' }}>Statement</span>
        </h1>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            World STEM Cup Education Foundation maintains strict academic independence in all aspects of 
            competition design, question development, and evaluation processes.
          </p>
          ...
          <p style={{
            ...
            Our Academic Council operates autonomously from organizational leadership, ensuring that 
            educational standards and competitive integrity remain free from external influence.
          </p>
          ...
          <p style={{
            ...
            For complete details on our academic independence policies and procedures, please download 
