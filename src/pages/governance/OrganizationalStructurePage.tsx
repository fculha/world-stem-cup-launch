            ...
            <div style={{ position: 'relative' }}>
              ...
              {showGovernanceDropdown && (
                <div style={{
                  ...
                  <Link to="/governance/organizational-structure" onClick={() => setShowGovernanceDropdown(false)} style={{ display: 'block', padding: '0.5rem 1rem', fontSize: '0.875rem', color: 'white', textDecoration: 'none', fontWeight: '500' }}>Organizational Structure</Link>
                </div>
              )}
            </div>
