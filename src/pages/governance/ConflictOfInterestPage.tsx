    ...
    <div style={{
            ...
            <div style={{ position: 'relative' }}>
              ...
              {showGovernanceDropdown && (
                <div style={{
                  ...
                  <Link to="/governance/conflict-of-interest" onClick={() => setShowGovernanceDropdown(false)} style={{ display: 'block', padding: '0.5rem 1rem', fontSize: '0.875rem', color: 'white', textDecoration: 'none', fontWeight: '500' }}>Conflict of Interest</Link>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <span style={{ color: '#7c3aed', fontWeight: '500' }}>Governance & Transparency</span>
        </div>
        ...
        <h1 style={{
          ...
          <span style={{ color: '#ffd700' }}>Public Statement</span>
        </h1>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            World STEM Cup Education Foundation is committed to maintaining the highest standards of 
            ethical conduct and transparency in all organizational activities.
          </p>
          ...
          <p style={{
            ...
            This public statement outlines our policies for identifying, disclosing, and managing 
            potential conflicts of interest among board members, staff, volunteers, and partners.
          </p>
          ...
          <p style={{
            ...
            For complete details on our conflict of interest policies and procedures, please download 
            the full public statement document.
          </p>
        </div>
