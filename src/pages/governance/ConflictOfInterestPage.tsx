            ...
            >
              ...
              {showGovernanceDropdown && (
                <div style={{
                  ...
                  <Link to="/governance/conflict-of-interest" style={{ display: 'block', padding: '0.5rem 1rem', fontSize: '0.875rem', color: 'white', textDecoration: 'none', fontWeight: '500' }}>Conflict of Interest</Link>
